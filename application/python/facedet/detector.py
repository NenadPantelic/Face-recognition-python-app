...
if __name__ == "__main__":
	...
	detector = CascadedDetector(cascade_fn="/home/dzoni/Programs/opencv-2.4.13/opencv-2.4.13/data/haarcascades/haarcascade_frontalface_alt2.xml")
	eyesDetector = CascadedDetector(scaleFactor=1.1,minNeighbors=5, minSize=(20,20), cascade_fn="/home/dzoni/Programs/opencv-2.4.13/opencv-2.4.13/data/haarcascades/haarcascade_eye.xml")
	# detekcija
	...
	# prikazi sliku ili upisi u fajl
